...
export class StringAssertion extends IntuitiveAssertions<string> {
  ...
  public contains(expected: string): Continuance<this> {
    Execute.stuff
      .checkCondition(!this.opposite ? this.actual.includes(expected) : !this.actual.includes(expected))
      .throwWithMessage(
        !this.opposite
  ...
  public containsAll(expectedStringArray: Array<string>): Continuance<this> {
    expectedStringArray.forEach((expectedString) => {
      Execute.stuff
        .checkCondition(!this.opposite ? this.actual.includes(expectedString) : !this.actual.includes(expectedString))
        .throwWithMessage(
          !this.opposite
  ...
  public containsAny(expectedStringArray: Array<string>): Continuance<this> {
    expectedStringArray.forEach((expectedString) => {
      if (!this.opposite ? !this.actual.includes(expectedString) : this.actual.includes(expectedString)) {
  ...
  public startsWith(expected: string): Continuance<this> {
    Execute.stuff
      .checkCondition(!this.opposite ? this.actual.startsWith(expected) : !this.actual.startsWith(expected))
      .throwWithMessage(
        !this.opposite
  ...
  public endsWith(expected: string): Continuance<this> {
    Execute.stuff
      .checkCondition(!this.opposite ? this.actual.endsWith(expected) : !this.actual.endsWith(expected))
      .throwWithMessage(
        !this.opposite
  ...
  public hasLength(expectedLength: number): Continuance<this> {
    Execute.stuff
      .checkCondition(!this.opposite ? this.actual.length === expectedLength : this.actual.length !== expectedLength)
      .throwWithMessage(
        !this.opposite
  ...
  public match(regexExpr: string | RegExp): Continuance<this> {
    if (!this.opposite ? this.actual.match(regexExpr) === null : this.actual.match(regexExpr) !== null) {
      Execute.stuff.throwWithMessage(
        !this.opposite
